...
export default function LiveSitePreview({
  ...
  const html = useMemo(() => buildHtml(jsx || "ReactDOM.createRoot(document.getElementById('root')).render(React.createElement('div', {style:{padding:40,fontFamily:'sans-serif',color:'#888'}}, '⏳ في انتظار التوليد...'));"), [jsx]);
  return (
    <iframe
      title="Live preview"
      srcDoc={html}
